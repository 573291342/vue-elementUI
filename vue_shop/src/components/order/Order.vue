  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column prop="order_price" label="订单价格" width="70px" align="center"></el-table-column>
        <el-table-column prop="pay_status" label="是否付款" width="100px" align="center">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.pay_status === '0'" type="danger" align="center">未付款</el-tag>
            <el-tag v-else type="success">已付款</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="is_send" label="是否发货" width="70px" align="center"></el-table-column>
